USE [P3_DB]
GO
/****** Object:  User [ppp_user]    Script Date: 21-Jun-22 10:32:42 PM ******/
IF NOT EXISTS (SELECT * FROM sys.database_principals WHERE name = N'ppp_user')
...
GO
/****** Object:  Schema [AUTH]    Script Date: 21-Jun-22 10:32:42 PM ******/
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = N'AUTH')
EXEC sys.sp_executesql N'CREATE SCHEMA [AUTH]'
GO
/****** Object:  Schema [COMMON]    Script Date: 21-Jun-22 10:32:42 PM ******/
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = N'COMMON')
EXEC sys.sp_executesql N'CREATE SCHEMA [COMMON]'
GO
/****** Object:  Schema [LT_COMMON]    Script Date: 21-Jun-22 10:32:42 PM ******/
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = N'LT_COMMON')
EXEC sys.sp_executesql N'CREATE SCHEMA [LT_COMMON]'
GO
/****** Object:  Table [AUTH].[USERS]    Script Date: 21-Jun-22 10:32:42 PM ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Object:  Table [COMMON].[CCase]    Script Date: 21-Jun-22 10:32:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[COMMON].[CCase]') AND type in (N'U'))
BEGIN
...
END
GO
/****** Object:  Table [COMMON].[CPU]    Script Date: 21-Jun-22 10:32:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[COMMON].[CPU]') AND type in (N'U'))
BEGIN
...
END
GO
/****** Object:  Table [COMMON].[CPU_COOLER]    Script Date: 21-Jun-22 10:32:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[COMMON].[CPU_COOLER]') AND type in (N'U'))
BEGIN
...
END
GO
/****** Object:  Table [COMMON].[GPU]    Script Date: 21-Jun-22 10:32:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[COMMON].[GPU]') AND type in (N'U'))
BEGIN
...
END
GO
/****** Object:  Table [COMMON].[M2]    Script Date: 21-Jun-22 10:32:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[COMMON].[M2]') AND type in (N'U'))
BEGIN
...
END
GO
/****** Object:  Table [COMMON].[Memory]    Script Date: 21-Jun-22 10:32:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[COMMON].[Memory]') AND type in (N'U'))
BEGIN
...
END
GO
/****** Object:  Table [COMMON].[Monitor]    Script Date: 21-Jun-22 10:32:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[COMMON].[Monitor]') AND type in (N'U'))
BEGIN
...
END
GO
/****** Object:  Table [COMMON].[MOTHERBOARD]    Script Date: 21-Jun-22 10:32:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[COMMON].[MOTHERBOARD]') AND type in (N'U'))
BEGIN
...
END
GO
/****** Object:  Table [COMMON].[PSU]    Script Date: 21-Jun-22 10:32:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[COMMON].[PSU]') AND type in (N'U'))
BEGIN
...
END
GO
/****** Object:  Table [COMMON].[SATA]    Script Date: 21-Jun-22 10:32:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[COMMON].[SATA]') AND type in (N'U'))
BEGIN
...
END
GO
/****** Object:  Table [LT_COMMON].[BUILD]    Script Date: 21-Jun-22 10:32:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]') AND type in (N'U'))
BEGIN
...
GO
INSERT [LT_COMMON].[BUILD] ([Build_ID], [Name], [CPU_ID], [MotherBoard_ID], [Memory_ID], [GPU_ID], [Cooler_ID], [M2_ID], [SATA_ID], [Monitor_ID], [PSU_ID], [Case_ID], [User_ID], [Price]) VALUES (N'a6378441-de42-4a6b-99cf-b0b1334a4a73', N'Example Build', N'f1fc81b4-1944-4697-b73f-5c78f1764ade', N'9e406478-0022-4960-8728-e853f87a5f51', N'd39b9230-ed95-49c1-9a70-36e103ceff22', N'1537bf80-ee2a-4923-b7e0-b93b2766a67b', N'0f2f76be-4f7c-4139-9793-94f6990ecf3e', N'cc560a26-b65c-40fd-b0cb-0ba2e3f44e2f', NULL, N'1a05e9d9-4fb0-42ee-8757-1ed90ecb20ef', N'4ca7d727-66f8-404c-97b9-89d9a7ad88e2', N'93c02ded-3797-4b6a-a700-89a2bdb95dc1', N'5efe2fb5-8acd-49dd-9d87-ad0a0b2e9dca', 3000)
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_CCase]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD]  WITH CHECK ADD  CONSTRAINT [FK_BUILD_CCase] FOREIGN KEY([Case_ID])
REFERENCES [COMMON].[CCase] ([Case_ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_CCase]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD] CHECK CONSTRAINT [FK_BUILD_CCase]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_CPU]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD]  WITH CHECK ADD  CONSTRAINT [FK_BUILD_CPU] FOREIGN KEY([CPU_ID])
REFERENCES [COMMON].[CPU] ([CPU_ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_CPU]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD] CHECK CONSTRAINT [FK_BUILD_CPU]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_CPU_COOLER]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_CPU_COOLER]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD] CHECK CONSTRAINT [FK_BUILD_CPU_COOLER]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_GPU]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD]  WITH CHECK ADD  CONSTRAINT [FK_BUILD_GPU] FOREIGN KEY([GPU_ID])
REFERENCES [COMMON].[GPU] ([GPU_ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_GPU]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD] CHECK CONSTRAINT [FK_BUILD_GPU]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_M2]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD]  WITH CHECK ADD  CONSTRAINT [FK_BUILD_M2] FOREIGN KEY([M2_ID])
REFERENCES [COMMON].[M2] ([M2_ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_M2]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD] CHECK CONSTRAINT [FK_BUILD_M2]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_Memory]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_Memory]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD] CHECK CONSTRAINT [FK_BUILD_Memory]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_Monitor]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_Monitor]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD] CHECK CONSTRAINT [FK_BUILD_Monitor]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_MOTHERBOARD]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_MOTHERBOARD]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD] CHECK CONSTRAINT [FK_BUILD_MOTHERBOARD]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_PSU]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD]  WITH CHECK ADD  CONSTRAINT [FK_BUILD_PSU] FOREIGN KEY([PSU_ID])
REFERENCES [COMMON].[PSU] ([PSU_ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_PSU]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD] CHECK CONSTRAINT [FK_BUILD_PSU]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_SATA]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD]  WITH CHECK ADD  CONSTRAINT [FK_BUILD_SATA] FOREIGN KEY([SATA_ID])
REFERENCES [COMMON].[SATA] ([SATA_ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_SATA]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD] CHECK CONSTRAINT [FK_BUILD_SATA]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_USERS]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
ALTER TABLE [LT_COMMON].[BUILD]  WITH CHECK ADD  CONSTRAINT [FK_BUILD_USERS] FOREIGN KEY([User_ID])
REFERENCES [AUTH].[USERS] ([User_ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[LT_COMMON].[FK_BUILD_USERS]') AND parent_object_id = OBJECT_ID(N'[LT_COMMON].[BUILD]'))
